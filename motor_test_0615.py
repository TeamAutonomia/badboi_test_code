        ...
        if len(data) > 0:
            ...
            if data[0] == '\x1B' and len(data) == 9:
                if count < 10:
                    ...
                    distance[0] = distance[0] + decode_2y0a41(struct.unpack('B', data[1])[0])
...
def motor():
    ...
    # set_right_speed(0.7)
    #set_left_speed(0.3)
    if average_distance[1] < 50 or average_distance[4] < 50:
        print("front")
        if average_distance[1] < average_distance[4]:
            print("turn right")
            set_right_speed(0.5)
            set_left_speed(1)
        else:
    ...
    elif average_distance[0] < 10 or average_distance[5] < 10:
        print("side")
        if average_distance[0] < average_distance[5]:
            print("")
            set_right_speed(0.5)
            set_left_speed(1)
        else:
